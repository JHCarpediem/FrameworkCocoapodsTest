...
public:
    ...
    *            };
    * 
    *            vctInfor是一个结构体数组，包含了数据流的额外信息
    *            实参举例：
    *            元素0:  {0, "等于大气压力" }
    *            元素1:  {1, "该值根据大气压力传感器计算得出。标准大气压力：101 kPa(abs) ,该值随天气改变。" }
    *            元素2:  {2, "发动机开关置于 ON (IG) 位置：101 kPa(abs)" }
    * 
    ...
    *    说  明：无
    ****************************************************************************************************************/
    uint32_t SetInformation(uint16_t uIndex, const std::vector<stLdInformation>& vctInfor);
    ...
    *            如果大小为0，表示没有选中任何一项
    **********************************************************/
    std::vector<uint16_t> GetSelectedItems();
    ...
    *************************************************************************************/
    std::vector<uint16_t> GetReportItems();
    ...
    *            如果用户没有修改过，返回数组为空
    *************************************************************************************/
    std::vector<uint16_t> GetLimitsModifyItems();
    ...
    *
    *************************************************************************************/
    uint32_t GetLimits(uint16_t uIndex, std::string& strMin, std::string& strMax);

...
@objc public extension UIImageView
{
    ...
    var theme_highlightedImage: ThemeImagePicker? {
        get { return getThemePicker(self, "setHighlightedImage") as? ThemeImagePicker }
        set { setThemePicker(self, "setHighlightedImage", newValue) }
    }
}

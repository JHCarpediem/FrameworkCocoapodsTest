...
/// 在Swift中 判断一个optional 字符串是否为空  如果字符串为nil 返回yes
/// let str: String? = nil
/// str.td.isEmpty ==  true 
extension TDBasisWrap where Base == Optional<String> {
    ...
    public func `default`(with value: String = "") -> String {
        switch base {
        case .none:
            return value
        case .some(let wrapped):
            return wrapped.td.default(with: value)
        }
    }
}

/// 在Swift中 判断一个optional 数组是否为空  如果字符串为nil 返回yes
/// let arr: Array<Int>? = nil
/// arr.td.isEmpty     ==     true
extension TDBasisWrap where Base == Optional<Array<Any>> {
    public var isEmpty: Bool {
        switch base {
        case .none:
            return true
...
extension TDBasisWrap where Base == Optional<any TDCompatible> {
    public var td: TDBasisWrap<Optional<any TDCompatible>>? {
        get {
            switch base {
            case .none:
                return nil
            case .some(let wrapped):
                return TDBasisWrap(wrapped)
            }
        }
        set {

...
//  AD200
//
//  Created by Diag on 2022/4/28.
//

#import "TDD_ArtiButtonCollectionCellView.h"
@import TDBasis;

@interface TDD_ArtiButtonCollectionCellView ()
...
@implementation TDD_ArtiButtonCollectionCellView
...
- (void)btnClick:(UIButton *)btn{
    if ([self.delegate respondsToSelector:@selector(ArtiButtonCollectionCellButtonClick:cell:)]) {
        [self.delegate ArtiButtonCollectionCellButtonClick:btn cell:self];
    }
}

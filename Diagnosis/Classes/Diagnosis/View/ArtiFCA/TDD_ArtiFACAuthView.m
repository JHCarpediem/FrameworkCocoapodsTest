...
- (void)createData {
    ...
    self.phoneArr = @[@"(+1) 833-628-4835",@"+34 930 038 086"];
    self.emailArr = @[@"support@VCI.us",@"support.eu@VCI.com"];
    self.webArr = @[@"https://www.VCI.us/",@"https://eu.VCI.com/"];
    self.unlockTypeTitleArr = @[TDDLocalized.VCI_account, TDDLocalized.europe_fca_official_site];
...
//        make.size.mas_equalTo(_fcaLogoSize);
    ...
    emailSpecLabel.text = [NSString stringWithFormat:@"%@: support@diag.us", TDDLocalized.tech_support];
    ...
    techSpecLabel.text = [NSString stringWithFormat:@"%@: (+1) 833-64329-55", TDDLocalized.contact_number];
...
- (void)updateUType {
    ...
    switch (_fcaModel.uType) {
        ...
        case SST_FUNC_NISSAN_AUTH:
        {
            ...
            UIImageView *fcaTDLogoImage = [UIImage tdd_imageDiagGateWayFCAdiagLogo];

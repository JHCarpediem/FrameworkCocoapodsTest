...
- (void)createBottomView {
    ...
    noteContentLabel.text = TDDLocalized.renault_gateway_hint;
...
- (void)setFcaModel:(TDD_FCAAuthModel *)fcaModel {
    ...
    switch (_fcaModel.uType) {
        case SST_FUNC_FCA_AUTH:
            normalNoteStr = isDeepDiag ? TDDLocalized.fca_gateway_hint_DeepDiag : TDDLocalized.fca_north_america_gateway_hint;
            break;
        case SST_FUNC_RENAULT_AUTH:
            normalNoteStr = isDeepDiag ? TDDLocalized.gateway_buy_tips_neutral_DeepDiag : TDDLocalized.gateway_buy_tips_neutral;
            break;
        case SST_FUNC_NISSAN_AUTH:
            normalNoteStr = isDeepDiag ? TDDLocalized.renault_gateway_hint_new_nissan_DeepDiag : TDDLocalized.nissan_gateway_hint;
            break;
        case SST_FUNC_VW_SFD_AUTH:
            normalNoteStr = isDeepDiag ? TDDLocalized.vw_gateway_hint_DeepDiag : TDDLocalized.vw_gateway_hint;
            break;

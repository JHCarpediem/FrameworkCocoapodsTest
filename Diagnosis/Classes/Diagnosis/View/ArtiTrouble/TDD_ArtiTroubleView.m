...
- (void)configureCollectionCell:(UICollectionViewCell *)cell atIndexpath:(NSIndexPath *)indexPath{
    ...
    //AI 引导
    if ((([TDD_DiagnosisTools customizedType] == TDD_Customized_Germany) || ([TDD_DiagnosisManage sharedManage].functionConfigMask & 1) || ([TDD_DiagnosisTools softWareIsCarDiagSeries])) && indexPath.row == 0) {

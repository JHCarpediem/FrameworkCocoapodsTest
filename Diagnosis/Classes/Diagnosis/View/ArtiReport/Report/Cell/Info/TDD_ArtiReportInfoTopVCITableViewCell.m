//
//  TDD_ArtiReportInfoTopVCITableViewCell.m
//  AD200
//
...
@implementation TDD_ArtiReportInfoTopVCITableViewCell
...
-(void)setupUI
{
    ...
    for (int i = 0; i < titleArray.count; i++) {
        if ([titleArray[i] isEqualToString:TDDLocalized.feedback_title]) {
            self.describeTitleLabel.font = [[UIFont systemFontOfSize:17] tdd_adaptHD];
            ...
            titleLabel.font = [[UIFont systemFontOfSize:14] tdd_adaptHD];
            ...
            valueLabel.font = [[UIFont systemFontOfSize:14] tdd_adaptHD];
...
-(void)updateWith:(TDD_ArtiReportCellModel *)model
{
    ...
    if (isKindOfTopVCI){
        ...
        // CarDiag (不是 CarDiagGuru ), 数据流报告和发动机 去掉车辆品牌、型号、年款、发动机、子型号
        if ([TDD_DiagnosisTools softWareIsCarDiag] && (model.reportType == 3 || (model.reportType == 2 && model.obdEntryType == OET_CARPAL_OBD_ENGINE_CHECK) )) {
            titleArray = @[
                TDDLocalized.feedback_title,
                TDDLocalized.report_license_plate,
    ...
    NSArray *valueArray = @[
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith:model.describe_title],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_license_plate_number],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_brand],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_model],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_year],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_mileage],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_engine],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_engine_subType],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_diagnosis_time],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_version],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_software_version],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.inputVIN],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_diagnosis_path],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_customer_name],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.describe_customer_call],
        [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith: model.repairOrderNum],
    ];
    if (isKindOfTopVCI){
        valueArray = @[
            [TDD_ArtiReportInfoTopVCITableViewCell getFlatStringWith:model.describe_title],
    ...
    for (int i = 0; i < titleArray.count; i++) {
        ...
        CGFloat gap = 10;
        CGFloat oneRowHeight = [NSString tdd_getHeightWithText:@"TEXT" width:maxWidth fontSize:[[UIFont systemFontOfSize:14] tdd_adaptHD]];
        CGFloat valueHeight = MAX([NSString tdd_getHeightWithText:titleAndValue width:maxWidth fontSize:[[UIFont systemFontOfSize:14] tdd_adaptHD]], oneRowHeight);
...
//            titleLabel.textColor = [UIColor tdd_title];
            ...
            NSMutableAttributedString *attributeTitle = [NSMutableAttributedString mutableAttributedStringWithLTRString:title attributes:@{
                NSForegroundColorAttributeName : [UIColor tdd_title],
                    NSFontAttributeName : [[UIFont systemFontOfSize:14] tdd_adaptHD]
                }];
...
-(void)updateA4With:(TDD_ArtiReportCellModel *)model
{
    ...
    for (int j = 0; j < titleArray.count; j++) {
        if (j >= titleArray.count) continue;
        NSArray *titles = titleArray[j];
        CGFloat rowHeight = 0;
        CGFloat gap = 5;
        for (int i = 0; i < titles.count; i++) {
            NSString *title = titles[i];
            NSString *value = valueArray[j][i];
            NSString *titleAndValue = [NSString stringWithFormat:@"%@%@", title, value];
            CGFloat maxWidth = A4Width / 2;
            CGFloat oneRowHeight = [NSString tdd_getHeightWithText:@"TEXT" width:maxWidth fontSize:[[UIFont systemFontOfSize:10] tdd_adaptHD]];
            CGFloat valueHeight = MAX([NSString tdd_getHeightWithText:titleAndValue width:maxWidth fontSize:[[UIFont systemFontOfSize:10] tdd_adaptHD]], oneRowHeight);
            
            
            rowHeight = MAX(rowHeight, valueHeight);
            
            if (j >= labelArray.count) continue;
            
            NSArray *rowLabels = labelArray[j];
            if (i >= rowLabels.count) continue;
            
            TDD_CustomLabel *label = rowLabels[i];
           
            
            NSMutableAttributedString *attributeTitle = [NSMutableAttributedString mutableAttributedStringWithLTRString:title attributes:@{
                    NSForegroundColorAttributeName : [UIColor tdd_pdfDtcNormalColor],
                    NSFontAttributeName : [[UIFont systemFontOfSize:10] tdd_adaptHD]
                }];
            NSMutableAttributedString *attributeValue = [NSMutableAttributedString mutableAttributedStringWithLTRString:value attributes:@{
                    NSForegroundColorAttributeName :  [UIColor tdd_colorWithHex:0x666666],
                    NSFontAttributeName : [[UIFont systemFontOfSize:10] tdd_adaptHD]
                }];
            ...
            [attributeTitleAndValue appendAttributedString:attributeTitle];
            [attributeTitleAndValue appendAttributedString:attributeValue];
            label.attributedText = attributeTitleAndValue;
        ...
        if (rowLabels.count == 1) {
            [rowLabels mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            [rowLabels mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:5 leadSpacing:15 tailSpacing:15];
            [rowLabels mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.mas_equalTo(totalHeight);
                make.height.mas_equalTo(rowHeight);
            }];

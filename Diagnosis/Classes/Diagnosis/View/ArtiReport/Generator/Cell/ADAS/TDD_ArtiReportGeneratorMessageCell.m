...
- (TDD_PlaceholderTextView *)textView {
    if (!_textView) {
        ...
        _textView.placeholderColor = ([TDD_DiagnosisTools softWareIsTopVCI] || [TDD_DiagnosisTools softWareIsCarDiagSeries]) ? [UIColor tdd_colorWithHex:0xFFFFFF alpha:0.5] : [UIColor tdd_colorCCCCCC];

...
- (void)inputTextFieldEditingChanged {
    ...
    self.inputTextField.text = [TDD_DiagnosisTools softWareIsCarDiagSeries] ? [self.inputTextField.text tdd_removeContainSpaceFileSpecialString] : [self.inputTextField.text tdd_removeFileSpecialString];
}

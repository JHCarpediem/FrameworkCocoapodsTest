...
/*
 +++++++++++++++++++ 固件升级相关说明 +++++++++++++++++++++++++++
 ## 1. How to offline update the CarArtiVCI Device Firmware
 ...
 # The CarArtiVCI Device Firmware Update
 ## 1.  CarArtiVCI Device Firmware placed in the memory address 0x08020000 start from Sector 5 in MCU.

 ## 2.  Normally, CarArtiVCI Device Firmware Bin File Size about 150KByte~448KByte.

 ## 3.  Update the CarArtiVCI Device Firmware Step as bellow:
 ...
 ## 4.  "CarArtiVciApp.bin" -- the firmware bin file

     Image Formats View:
          _________________________
         |  CarArtiVCI Image Head |
         |         (64Bytes)       |
         |_________________________|
         |                         |
         |         Software        |
     ...
     Image Formats Structure
         ...
         |   version   |    0010h    |    16         |  device version string, Example 'CarArti V1.02'  |
         |_____________|_____________|_______________|___________________________________________________|
     ...
     00000010h: 41 72 74 69 44 69 61 67 20 56 31 2E 30 32 00 00 ; CarArti V1.02..
     00000020h: 00 03 27 00 01 2C 8D E3 00 00 00 00 00 00 00 00 ; ..'..,嶃........
     00000030h: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; ................

     strDeviceType = "AD900Relay207"
     strDeviceVersion = "CarArti V1.02"
     size = 0x00032700
     checksum = 0x012C8DE3
*/
...
// App透传IOT接口
// 成功返回1，失败返回0
// strdiagID    对应的用户的diagID
// strMagic       加密处理过的字符串
+ (int )runMaigc:(NSString *)diagId magic:(NSString *)magic;
// 设置VCI解锁状态
// 成功返回1，失败返回0

...
typedef enum
{   //当前app应用的产品名称
    PD_NAME_Diag   = 2,          // "AD200",     表示当前产品名为AD200
...
typedef enum
{
    ...
    PD_GROUP_DIAG_LIKE                 = ((2 << 16) & 0xFFFF0000),   //
...
typedef enum {
    ...
    // 首页“发动机检测”快捷方式进入，例如CarDiag
    OET_CARPAL_OBD_ENGINE_CHECK = (1 << 5),  // CarDiag首页发动机检测, 1 << 5
    
    // 首页“IM预排放”快捷方式进入，例如CarDiag
    OET_CARPAL_IM_PROTOCOL      = (1 << 6),  // CarDiag首页IM预排放,   1 << 6
    ////////////////////////////////////////////////////////////////////////////////////////


    ///////////////////////////////     CarDiag Guru    /////////////////////////////////////
    // CarDiag Guru 首页“刷隐藏”快捷方式进入
    OET_CARPAL_GURU_HIDDEN      = (1 << 7),  // CarDiag Guru 首页刷隐藏,  1 << 7

    // CarDiag Guru 首页“数据流”快捷方式进入
    OET_CARPAL_GURU_DATASTREAM  = (1 << 8),  // CarDiag Guru 首页数据流,  1 << 8

    // CarDiag Guru 首页“动作测试”快捷方式进入
    OET_CARPAL_GURU_ACTIVE_TEST = (1 << 9),  // CarDiag Guru 首页动作测试, 1 << 9
    ////////////////////////////////////////////////////////////////////////////////////////


    ///////////////////////////////     DiagScan        /////////////////////////////////////
    // DiagScan 首页“OBD”快捷方式进入
    OET_TOPSCAN_OBD_SHORTCUT    = (1 << 10),  // DiagScan 首页快速进入,  1 << 10
    ////////////////////////////////////////////////////////////////////////////////////////
...
返 回 值： 返回举例
           ...
           "CarArti200"        // 表示 顶匠 CarArti200诊断设备
           "CarArti500"        // 表示 鼎匠 CarArti500 自研
           "CarArti500S"       // 表示 鼎匠 CarArti500 S 自研
           "CarArti500 BMS"    // 表示 鼎匠 CarArti500 BMS
           "CarArti600"        // 表示 鼎匠 CarArti600 自研
           "CarArti600S"       // 表示 鼎匠 CarArti600 S 自研
           "CarArti600 Pro"    // 表示 鼎匠 CarArti600 Pro
           "CarArti600 Elite"  // 表示 鼎匠 CarArti600 Elite
           "CarArti800 BT 2"   // 表示 鼎匠 CarArti800 BT 2 诊断设备
           "CarArti700"        // 表示 顶匠 CarArti700诊断设备
           "CarArti Moto"      // 表示 CarArti Moto 智能摩托车诊断仪
           "CarArti900 Lite"   // 表示 顶匠 CarArti900 Lite诊断设备
           "UltraDiag"          // 表示 顶匠 UltraDiag诊断设备
           "DiagScan"            // 表示 DiagScan
           "DiagScan Pro"        // 表示 鼎匠 DiagScan Pro诊断设备
           "DiagScan Master"     // 表示 鼎匠 DiagScan Master 诊断设备
           "CarDiag"             // 表示 鼎匠 CarDiag诊断设备
           "CarDiag Guru"        // 表示 鼎匠 CarDiag Guru 带刷隐藏诊断设备

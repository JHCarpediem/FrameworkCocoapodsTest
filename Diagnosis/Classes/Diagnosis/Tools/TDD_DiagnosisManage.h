...
#define  KTDDNotificationCarArtiStart          @"KTDDNotificationCarArtiStart"                  //进车
#define  KTDDNotificationCarArtiStop           @"KTDDNotificationCarArtiStop"                   //退车
#define  KTDDNotificationCarArtiStopCranking   @"KTDDNotificationCarArtiStopCranking"           //退出电池检测
...
///   - message: 信息
///   - type: 0:车型路径、1:VIN
- (void)insertMessageToDiagLog:(NSString *)message time:(NSTimeInterval )time type:(NSInteger )type;
@optional
/// 评分字体

...
+ (void)vehicleDecompressionPackage
{
    ...
    for (int i = 0; i < packageAry.count; i++) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            NSString *resourcePath = [bundle pathForResource:[NSString stringWithFormat:@"Diagnosis.bundle/%@", [packageAry objectAtIndex:i]] ofType:@"zip"];
...
+ (BOOL )softWareIsCarDiagSeries {
    return (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareCarDiag) || (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareCarDiagGuru);
}

+ (BOOL )softWareIsCarDiag {
    return (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareCarDiag) && ( (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareCarDiagGuru) == 0);
}

+ (BOOL )softWareIsCarDiagGuru {
    return ( (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareCarDiag) == 0) && (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareCarDiagGuru);
}

+ (BOOL )softWareIsDiagScan {
    return TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScan;
}

+ (BOOL )softWareIsKindOfDiagScan {
    return (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScan || TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareTopVciPro || TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScanHD || [TDD_DiagnosisTools softWareIsSingleApp]);
}

+ (BOOL )softWareIsSingleApp {
    return (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScanVAG || TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScanBMW || TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScanFORD);
...
+ (BOOL )isIpad {
    ...
    return (TDD_DiagnosisManage.sharedManage.currentSoftware & TDDSoftwareDiagScanHD);
}
...
+ (NSString *)diagID {
    if ([[TDD_DiagnosisManage sharedManage].manageDelegate respondsToSelector:@selector(diagID)]) {
        return [[TDD_DiagnosisManage sharedManage].manageDelegate diagID]?:@"";
    }
    return @"";
}
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        if (isExist) {
            ...
            if isKindOfTopVCI {
                ...
                if (![deviceTypeStr isEqualToString:@"DeepDiagN32H487"]) {
                    if (completionHandler) {
                        completionHandler(2);
                    }
                    return;

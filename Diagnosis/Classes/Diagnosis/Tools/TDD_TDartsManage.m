...
- (void)setTProgStatus:(uint32_t)TProgStatus {
    ...
    if (_TProgStatus != TProgStatus && !TProgStatus && [TDD_EADSessionController sharedController].isCarArti && [TDD_ArtiGlobalModel sharedArtiGlobalModel].diagShowType == TDD_DiagShowType_TDarts) {

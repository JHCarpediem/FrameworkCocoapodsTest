...
@implementation CBOBD2AdapterELM327
{
    NSString* _version;
}
...
#pragma mark -
#pragma mark CBOBD2Adapter Overrides
...
-(void)trySlowInitializationWithProtocol:(OBD2VehicleProtocol)protocol
{
    ...
    CBOBD2CommandELM327_TRY_PROTOCOL* tryProtocol = [CBOBD2CommandELM327_TRY_PROTOCOL commandForProtocol:protocol];
    CBOBD2Command* test0100 = [CBOBD2Command commandWithRawString:@"0100"];
    [self transmitMultipleCommands:@[ tryProtocol, test0100 ] responseHandler:^(CBOBD2Command * _Nonnull command) {
...
@implementation CBOBD2CommandELM327_IDENTIFY
...
@implementation CBOBD2CommandELM327_READ_VOLTAGE
...
@implementation CBOBD2CommandELM327_IGNITION_STATUS
...
@implementation CBOBD2CommandELM327_TRY_PROTOCOL
...
@implementation CBOBD2CommandELM327_SET_PROTOCOL
...
@implementation CBOBD2CommandELM327_DESCRIBE_PROTOCOL
...
@implementation CBOBD2CommandELM327_DESCRIBE_PROTOCOL_NUMERIC

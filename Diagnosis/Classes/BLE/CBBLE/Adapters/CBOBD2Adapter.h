...
typedef void(^LTOBD2MultipleCommandsResponseHandler)(NSArray<CBOBD2Command*>* commands);
typedef void(^CBOBD2CommandResponseHandler)(CBOBD2Command* command);
typedef void(^LTOBD2RawResponseHandler)(NSArray<NSString*>* _Nullable response);

extern NSString* const CBOBD2AdapterDidUpdateState;
extern NSString* const CBOBD2AdapterDidOpenStream;
extern NSString* const CBOBD2AdapterDidSend;
extern NSString* const CBOBD2AdapterDidReceive;

@interface CBOBD2Adapter : NSObject <NSStreamDelegate>

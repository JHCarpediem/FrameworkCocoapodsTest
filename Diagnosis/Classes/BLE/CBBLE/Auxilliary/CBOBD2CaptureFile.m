...
@implementation CBOBD2CaptureFile
...
+(void)initialize
{
    if ( self != CBOBD2CaptureFile.class )
    {
        return;
    }
...
-(BOOL)isEqual:(id)object
{
    ...
    if ( ! [object isKindOfClass:CBOBD2CaptureFile.class] )
    {
        return NO;
    }
    return [self isEqualToCaptureFile:(CBOBD2CaptureFile*)object];
}

-(BOOL)isEqualToCaptureFile:(CBOBD2CaptureFile*)object
{
    for ( NSString* property in self.class.serializableProperties )
    {

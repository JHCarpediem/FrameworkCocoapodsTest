...
@implementation CBOBD2O2Sensor
{
    CBOBD2PID_OXYGEN_SENSORS_INFO_1* _info1;
    CBOBD2PID_OXYGEN_SENSORS_INFO_2* _info2;
    CBOBD2PID_OXYGEN_SENSORS_INFO_3* _info3;
    
    CBOBD2PID_OXYGEN_SENSORS_PRESENT_2_BANKS_13* _banks2;
    CBOBD2PID_OXYGEN_SENSORS_PRESENT_4_BANKS_1D* _banks4;
}
...
{
    CBOBD2O2Sensor* obj = [[self alloc] init];
...
{
    return [NSString stringWithFormat:@"<CBOBD2O2Sensor %u i1:%@ i2:%@ i3:%@>", (uint)_number, _info1.gotValidAnswer ? @"YES" : @"NO", _info2.gotValidAnswer ? @"YES" : @"NO", _info3.gotValidAnswer ? @"YES" : @"NO"];
}

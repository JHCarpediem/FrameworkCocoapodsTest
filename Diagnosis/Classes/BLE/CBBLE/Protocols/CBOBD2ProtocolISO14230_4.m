...
@implementation CBOBD2ProtocolISO14230_4
...
-(CBOBD2Command*)heartbeatCommand
{
    ...
    return [CBOBD2PID_TESTER_PRESENT_3E pid];
}

-(NSDictionary<NSString*,CBOBD2ProtocolResult*>*)decode:(NSArray<NSString*>*)lines originatingCommand:(NSString*)command
{
    NSMutableDictionary<NSString*,CBOBD2ProtocolResult*>* md = [NSMutableDictionary dictionary];
    ...
    for ( NSString* line in lines )
    {
        ...
        CBOBD2ProtocolResult* resultForSource = md[sourceKey];
        if ( !resultForSource )
        {

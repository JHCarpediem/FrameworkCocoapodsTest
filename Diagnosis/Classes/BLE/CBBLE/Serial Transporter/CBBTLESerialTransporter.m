...
NSString* const CBBTLESerialTransporterDidUpdateSignalStrength = @"CBBTLESerialTransporterDidUpdateSignalStrength";
...
@implementation CBBTLESerialTransporter
{
    ...
    CBBTLESerialTransporterConnectionBlock _connectionBlock;
    CBBTLEReadCharacteristicStream* _inputStream;
    CBBTLEWriteCharacteristicStream* _outputStream;
...
-(void)peripheral:(CBPeripheral *)peripheral didReadRSSI:(NSNumber *)RSSI error:(NSError *)error
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:CBBTLESerialTransporterDidUpdateSignalStrength object:self];
}
...
{
    _inputStream = [[CBBTLEReadCharacteristicStream alloc] initWithCharacteristic:_reader];
    _outputStream = [[CBBTLEWriteCharacteristicStream alloc] initToCharacteristic:_writer];

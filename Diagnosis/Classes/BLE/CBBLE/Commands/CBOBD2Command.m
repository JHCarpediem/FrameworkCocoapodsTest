...
-(void)didCookResponse:(NSDictionary<NSString*,CBOBD2ProtocolResult*>*)responseDictionary withProtocolType:(OBD2VehicleProtocol)protocol
{
    _protocol = protocol;
    ...
    [responseDictionary enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull source, CBOBD2ProtocolResult * _Nonnull result, BOOL * _Nonnull stop) {

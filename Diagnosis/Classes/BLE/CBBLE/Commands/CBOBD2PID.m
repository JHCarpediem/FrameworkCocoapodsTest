...
+(instancetype)pid
{
    ...
    CBOBD2PID* obj = [[self alloc] initWithString:suffix];
...
+(instancetype)pidForMode1
{
    ...
    CBOBD2PID* obj = [[self alloc] initWithString:string];
    obj->_freezeFrame = NSNotFound;
    return obj;
}

+(instancetype)pidForFreezeFrameDTC:(CBOBD2DTC*)freezeFrameDTC
{
...
-(instancetype)initWithString:(NSString*)string inFreezeFrameDTC:(CBOBD2DTC*)freezeFrameDTC
{
    NSAssert( freezeFrameDTC.associatedFreezeFrame != NSNotFound, @"This initializer needs a DTC w/ an associated freeze frame" );
    NSAssert( freezeFrameDTC.associatedFreezeFrame != NSNotFound, @"This initializer needs a DTC w/ an associated ECU source" );
...
@implementation CBOBD2PID_TEST_SUPPORTED_COMMANDS
...
+(instancetype)pidForMode:(NSUInteger)mode part:(NSUInteger)part
{
    ...
    CBOBD2PID_TEST_SUPPORTED_COMMANDS* obj = [[self alloc] initWithString:string];
    return obj;
}
...
+(instancetype)pidForFreezeFrameDTC:(CBOBD2DTC *)freezeFrameDTC part:(NSUInteger)part;
{
    ...
    CBOBD2PID_TEST_SUPPORTED_COMMANDS* obj = [[self alloc] initWithString:string inFreezeFrameDTC:freezeFrameDTC];
    return obj;
}
...
@implementation CBOBD2PIDDB
{
    CBOBD2DTC* _freezeFrameDTC;
    NSUInteger _mode;
...
{
    CBOBD2PIDDB* obj = [[self alloc] init];
    obj->_mode = mode;
    return obj;
}
...
{
    NSMutableArray<CBOBD2PID_TEST_SUPPORTED_COMMANDS*>* commands = [NSMutableArray array];
    ...
    {
        CBOBD2PID_TEST_SUPPORTED_COMMANDS* command = _freezeFrameDTC ? [CBOBD2PID_TEST_SUPPORTED_COMMANDS pidForFreezeFrameDTC:_freezeFrameDTC part:part] : [CBOBD2PID_TEST_SUPPORTED_COMMANDS pidForMode:_mode part:part];
        [commands addObject:command];
    }
    
    [adapter transmitMultipleCommands:commands responseHandler:^(CBOBD2Command * _Nonnull command) {
        ...
        for ( NSUInteger part = 0; part < numberOfParts; ++part )
        {
            CBOBD2PID_TEST_SUPPORTED_COMMANDS* command = [commands objectAtIndex:part];
...
@implementation CBOBD2PIDSingleByteTemperature
...
@implementation CBOBD2PIDDoubleByteTemperature
...
@implementation CBOBD2PIDSingleBytePercent
...
@implementation CBOBD2PIDStoredDTC

-(NSArray<CBOBD2DTC*>*)troubleCodes
{
    ...
    NSMutableArray<CBOBD2DTC*>* ma = [NSMutableArray array];
    ...
    [self.cookedResponse enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull ecu, NSArray<NSNumber *> * _Nonnull bytes, BOOL * _Nonnull stop) {
        ...
        for ( NSUInteger n = 0; n < codeBytes.count / 2; ++n )
        {
            ...
            CBOBD2DTC* dtc = [CBOBD2DTC dtcWithCode:code ecu:ecu];
            if ( dtc )
            {
                [ma addObject:dtc];
            }
...
@implementation CBOBD2PIDComponentMonitoring

-(CBOBD2MonitorResult*)monitorResultForName:(NSString*)name availableByte:(int)availableByte availableBit:(int)availableBit incompleteByte:(int)incompleteByte incompleteBit:(int)incompleteBit
{
    ...
    return [CBOBD2MonitorResult resultWithTestName:name result:testResult];
}

-(NSArray<CBOBD2MonitorResult*>*)monitorResults
{
    ...
    NSMutableArray<CBOBD2MonitorResult*>* ma = [NSMutableArray array];
    ...
    else
    {
        ...
        [ma addObject:[CBOBD2MonitorResult resultWithTestName:@"OBD2_NO_DATA" result:OBD2MonitorTestNotAvailable]];
...
@implementation CBOBD2PID_OXYGEN_SENSORS_INFO_1
{
    NSUInteger _sensor;
}
...
+(instancetype)pidForSensor:(NSUInteger)sensor mode:(NSUInteger)mode
{
    ...
    CBOBD2PID_OXYGEN_SENSORS_INFO_1* obj = [self commandWithString:cmd];
    obj->_sensor = sensor;
    return obj;
}
...
@implementation CBOBD2PID_OXYGEN_SENSORS_INFO_2
{
    NSUInteger _sensor;
}
...
+(instancetype)pidForSensor:(NSUInteger)sensor mode:(NSUInteger)mode
{
    ...
    CBOBD2PID_OXYGEN_SENSORS_INFO_2* obj = [self commandWithString:cmd];
    obj->_sensor = sensor;
    return obj;
}
...
@implementation CBOBD2PID_OXYGEN_SENSORS_INFO_3
{
    NSUInteger _sensor;
}
...
+(instancetype)pidForSensor:(NSUInteger)sensor mode:(NSUInteger)mode
{
    ...
    CBOBD2PID_OXYGEN_SENSORS_INFO_3* obj = [self commandWithString:cmd];
    obj->_sensor = sensor;
    return obj;
}
...
@implementation CBOBD2PIDPerformanceTracking

-(NSArray<CBOBD2PerformanceTrackingResult*>*)countersForMnemonics:(NSArray<NSString*>*)mnemonics
{
    NSMutableArray<CBOBD2PerformanceTrackingResult*>* ma = [NSMutableArray array];
    ...
    if ( self.isCAN )
    {
        ...
        for ( NSUInteger i = 0; i < numberOfValues; ++i )
        {
            ...
            CBOBD2PerformanceTrackingResult* result = [CBOBD2PerformanceTrackingResult resultWithMnemonic:mnemonic count:value];
            if ( result )
            {
                [ma addObject:result];
            }
    ...
    else
    {
        ...
        for ( NSUInteger i = 0; i < numberOfPairs; ++i )
        {
            ...
            value = A * 256 + B;
            result = [CBOBD2PerformanceTrackingResult resultWithMnemonic:mnemonic count:value];
            if ( result )
            {
                [ma addObject:result];
            }
...
@implementation CBOBD2PID_SUPPORTED_COMMANDS1_00
...
@implementation CBOBD2PID_MONITOR_STATUS_SINCE_DTC_CLEARED_01
...
@implementation CBOBD2PID_DTC_CAUSING_FREEZE_FRAME_02
...
-(NSArray<CBOBD2DTC*>*)troubleCodes
{
    ...
    [self.cookedResponse enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull ecu, NSArray<NSNumber *> * _Nonnull bytes, BOOL * _Nonnull stop) {
        ...
        if ( (A + B) )
        {
            ...
            NSString* code = [self dtcCodeForA:A B:B];
            CBOBD2DTC* dtc = [CBOBD2DTC dtcWithCode:code ecu:ecu freezeFrame:self.freezeFrame];
            if ( dtc )
            {
                [ma addObject:dtc];
            }
...
@implementation CBOBD2PID_FUEL_SYSTEM_STATUS_03
...
@implementation CBOBD2PID_ENGINE_LOAD_04
@end

@implementation CBOBD2PID_COOLANT_TEMP_05
@end

@implementation CBOBD2PID_SHORT_TERM_FUEL_TRIM_1_06
...
@implementation CBOBD2PID_LONG_TERM_FUEL_TRIM_1_07
...
@implementation CBOBD2PID_SHORT_TERM_FUEL_TRIM_2_08
...
@implementation CBOBD2PID_LONG_TERM_FUEL_TRIM_2_09
...
@implementation CBOBD2PID_FUEL_PRESSURE_0A
...
@implementation CBOBD2PID_INTAKE_MAP_0B
...
@implementation CBOBD2PID_ENGINE_RPM_0C
...
@implementation CBOBD2PID_VEHICLE_SPEED_0D
...
@implementation CBOBD2PID_TIMING_ADVANCE_0E
...
@implementation CBOBD2PID_INTAKE_TEMP_0F
@end

@implementation CBOBD2PID_MAF_FLOW_10
...
@implementation CBOBD2PID_THROTTLE_11
@end

@implementation CBOBD2PID_SECONDARY_AIR_STATUS_12
...
@implementation CBOBD2PID_OXYGEN_SENSORS_PRESENT_2_BANKS_13
...
@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_0_14
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_1_15
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_2_16
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_3_17
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_4_18
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_5_19
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_6_1A
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_1_SENSOR_7_1B
@end

@implementation CBOBD2PID_OBD_STANDARDS_1C
...
@implementation CBOBD2PID_OXYGEN_SENSORS_PRESENT_4_BANKS_1D
...
@implementation CBOBD2PID_AUX_INPUT_1E
...
@implementation CBOBD2PID_RUNTIME_1F
...
@implementation CBOBD2PID_DISTANCE_WITH_MIL_21
...
@implementation CBOBD2PID_FUEL_RAIL_PRESSURE_22
...
@implementation CBOBD2PID_FUEL_RAIL_GAUGE_PRESSURE_23
...
@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_0_24
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_1_25
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_2_26
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_3_27
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_4_28
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_5_29
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_6_2A
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_2_SENSOR_7_2B
@end

@implementation CBOBD2PID_COMMANDED_EGR_2C
@end

@implementation CBOBD2PID_EGR_ERROR_2D
...
@implementation CBOBD2PID_COMMANDED_EVAPORATIVE_PURGE_2E
@end

@implementation CBOBD2PID_FUEL_TANK_LEVEL_2F
@end

@implementation CBOBD2PID_WARMUPS_SINCE_DTC_CLEARED_30
...
@implementation CBOBD2PID_DISTANCE_SINCE_DTC_CLEARED_31
...
@implementation CBOBD2PID_EVAP_SYS_VAPOR_PRESSURE_32
...
@implementation CBOBD2PID_ABSOLUTE_BAROMETRIC_PRESSURE_33
...
@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_0_34
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_1_35
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_2_36
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_3_37
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_4_38
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_5_39
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_6_3A
@end

@implementation CBOBD2PID_OXYGEN_SENSOR_INFO_3_SENSOR_7_3B
@end

@implementation CBOBD2PID_CATALYST_TEMP_B1S1_3C
...
@implementation CBOBD2PID_CATALYST_TEMP_B2S1_3D
...
@implementation CBOBD2PID_CATALYST_TEMP_B1S2_3E
...
@implementation CBOBD2PID_CATALYST_TEMP_B2S2_3F
...
@implementation CBOBD2PID_MONITOR_STATUS_THIS_DRIVE_CYCLE_41
@end

@implementation CBOBD2PID_CONTROL_MODULE_VOLTAGE_42
...
@implementation CBOBD2PID_ABSOLUTE_ENGINE_LOAD_43
@end

@implementation CBOBD2PID_AIR_FUEL_EQUIV_RATIO_44
...
@implementation CBOBD2PID_RELATIVE_THROTTLE_POS_45
@end

@implementation CBOBD2PID_AMBIENT_TEMP_46
@end

@implementation CBOBD2PID_ABSOLUTE_THROTTLE_POS_B_47
@end

@implementation CBOBD2PID_ABSOLUTE_THROTTLE_POS_C_48
@end

@implementation CBOBD2PID_ACC_PEDAL_POS_D_49
@end

@implementation CBOBD2PID_ACC_PEDAL_POS_E_4A
@end

@implementation CBOBD2PID_ACC_PEDAL_POS_F_4B
@end

@implementation CBOBD2PID_COMMANDED_THROTTLE_ACTUATOR_4C
@end

@implementation CBOBD2PID_TIME_WITH_MIL_4D
...
@implementation CBOBD2PID_TIME_SINCE_DTC_CLEARED_4E
...
@implementation CBOBD2PID_MAX_VALUE_FUEL_AIR_EQUIVALENCE_RATIO_4F
...
@implementation CBOBD2PID_MAX_VALUE_OXYGEN_SENSOR_VOLTAGE_4F
...
@implementation CBOBD2PID_MAX_VALUE_OXYGEN_SENSOR_CURRENT_4F
...
@implementation CBOBD2PID_MAX_VALUE_INTAKE_MAP_4F
...
@implementation CBOBD2PID_MAX_VALUE_MAF_AIR_FLOW_RATE_50
...
@implementation CBOBD2PID_FUEL_TYPE_51
...
@implementation CBOBD2PID_ETHANOL_FUEL_52
@end

@implementation CBOBD2PID_ABSOLUTE_EVAP_SYSTEM_VAPOR_PRESSURE_53
...
@implementation CBOBD2PID_EVAP_SYSTEM_VAPOR_PRESSURE_54
...
@implementation CBOBD2PID_FUEL_RAIL_ABSOLUTE_PRESSURE_59
...
@implementation CBOBD2PID_RELATIVE_ACCELERATOR_PEDAL_POSITION_5A
@end

@implementation CBOBD2PID_HYBRID_BATTERY_PERCENTAGE_5B
@end

@implementation CBOBD2PID_ENGINE_OIL_TEMP_5C
@end

@implementation CBOBD2PID_FUEL_INJECTION_TIMING_5D
...
@implementation CBOBD2PID_ENGINE_FUEL_RATE_5E
...
@implementation CBOBD2PID_SUPPORTED_EMISSION_REQUIREMENTS_5F
...
@implementation CBOBD2PID_ENGINE_TORQUE_DEMANDED_61
...
@implementation CBOBD2PID_ENGINE_TORQUE_PERCENTAGE_62
...
@implementation CBOBD2PID_ENGINE_REF_TORQUE_63
...
@implementation CBOBD2PID_STORED_DTC_03
@end

#pragma mark -
#pragma mark Mode 04 – Clear Diagnostic Trouble Codes and stored values

@implementation CBOBD2PID_CLEAR_STORED_DTC_04
@end

#pragma mark -
#pragma mark Mode 05 – Oxygen Sensor Component Monitoring (not for CAN)

@implementation CBOBD2PID_SUPPORTED_PIDS_MODE_5_0500
@end

#pragma mark -
#pragma mark Mode 06 – Test Results Component Monitoring

@implementation CBOBD2PID_MODE_6_TEST_RESULTS_06
{
    NSUInteger _mid;
}

static const NSUInteger CBOBD2PID_MODE_6_PAYLOAD_LENGTH_NON_CAN = 5;
static const NSUInteger CBOBD2PID_MODE_6_PAYLOAD_LENGTH_CAN     = 9;
...
+(instancetype)pidForMid:(NSUInteger)mid
{
    ...
    CBOBD2PID_MODE_6_TEST_RESULTS_06* obj = [[self alloc] initWithString:string];
    obj->_mid = mid;
    return obj;
}

-(NSArray<CBOBD2Mode6TestResult*>*)testResults
{
    NSUInteger resultResponseLength = self.isCAN ? CBOBD2PID_MODE_6_PAYLOAD_LENGTH_CAN : CBOBD2PID_MODE_6_PAYLOAD_LENGTH_NON_CAN;
    ...
    NSMutableArray<CBOBD2Mode6TestResult*>* ma = [NSMutableArray array];
    ...
    while ( i < bytes.count )
    {
        ...
        CBOBD2Mode6TestResult* testResult = [CBOBD2Mode6TestResult resultWithMid:_mid bytes:subarray can:self.isCAN];
...
@implementation CBOBD2PID_PENDING_DTC_07
@end
...
@implementation CBOBD2PID_VIN_CODE_0902
...
@implementation CBOBD2PID_CALIBRATION_ID_0904
...
@implementation CBOBD2PID_CALIBRATION_VERIFICATION_0906
@end

@implementation CBOBD2PID_ECU_NAME_090A
...
@implementation CBOBD2PID_SPARK_IGNITION_PERFORMANCE_TRACKING_0908

-(NSArray<CBOBD2PerformanceTrackingResult*>*)counters
{
...
@implementation CBOBD2PID_COMPRESSION_IGNITION_PERFORMANCE_TRACKING_090B
...
@implementation CBOBD2PID_PERMANENT_DTC_0A
@end
...
@implementation CBOBD2PID_TESTER_PRESENT_3E

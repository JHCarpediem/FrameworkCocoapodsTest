...
//                                                       object:nil];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:sessionController selector:@selector(CarArtiStart) name:KTDDNotificationCarArtiStart object:nil];
        
        [[NSNotificationCenter defaultCenter] addObserver:sessionController selector:@selector(CarArtiStop) name:KTDDNotificationCarArtiStop object:nil];
...
- (void)setBatteryVolt:(float)BatteryVolt {
    ...
    }else if (_BatteryVolt >= 9 || !_VciStatus || !_isCarArti) {

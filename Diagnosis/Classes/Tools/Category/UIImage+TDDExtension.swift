...
public extension TDThemeBasis where Base == UIImage {
    ...
    static var tdd_diagReportInfo: ThemeImagePicker? { TDD_UIProvider.themeImage(with: "diag_report_bg") }
    ...
    static var tdd_diagGateWayFCAdiagLogo: ThemeImagePicker? { TDD_UIProvider.themeImage(with: "FCA_diag_logo") }
...
public extension UIImage {
    ...
    @objc class var tdd_diagGateWayFCAdiagLogo: UIImage? { UIImage.theme.tdd_diagGateWayFCAdiagLogo?.image }
...
public extension TDD_UIProvider.Image {
    ...
    static var diagGateWayFCAdiagLogo: UIImage? { UIImage.tdd_diagGateWayFCAdiagLogo }
...
public extension TDD_UIProvider.ThemeImage {
    ...
    static var diagGateWayFCAdiagLogo: ThemeImagePicker? { UIImage.theme.tdd_diagGateWayFCAdiagLogo }

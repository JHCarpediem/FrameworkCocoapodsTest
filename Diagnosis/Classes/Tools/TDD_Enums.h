...
{   //当前诊断的二级入口类型
    ...
    TDD_DiagShowSecondaryType_AF_HOTFUN_POS,      // 常用特殊功能         HOTFUNCTIONS
    TDD_DiagShowSecondaryType_AF_INIT_POS,      // 初始化               INITIALIZE
    TDD_DiagShowSecondaryType_AF_CODING_POS,      // 设码                 CODING
    TDD_DiagShowSecondaryType_AF_ADAPTATION_POS,      // 匹配                 ADAPTATION
    TDD_DiagShowSecondaryType_AF_PROGRAMMING_POS,      // 编程                 PROGRAMMING
    TDD_DiagShowSecondaryType_AF_ECUCLONING_POS,      // ECU克隆              ECUCLONING
    TDD_DiagShowSecondaryType_AF_CUSTOMIZE_POS,      // 刷隐藏               CUSTOMIZE
...
typedef NS_OPTIONS(NSUInteger, TDDSoftware) {
    TDDSoftwareDiagScan          = 1 << 0, // 1
    TDDSoftwareTopVci           = 1 << 1, // 2
    TDDSoftwareTopVciPro        = 1 << 2, // 4
    TDDSoftwareCarDiag           = 1 << 3, // 8
    TDDSoftwareCarDiagGuru       = 1 << 4, // 16
    TDDSoftwareKeyNow           = 1 << 5, // 32
    TDDSoftwareDiagScanHD        = 1 << 6, // 64
    TDDSoftwareDiagScanVAG       = 1 << 7,
    TDDSoftwareDeepDiag         = 1 << 8,
    TDDSoftwareDiagScanBMW       = 1 << 9,
    TDDSoftwareDiagScanFORD      = 1 << 10,
};
...
{   //当前诊断功能掩码下标
    ...
    // DEFE_MT_CUSTOMIZE_POS  温馨提示: 位61掩码（原刷隐藏掩码）, 已废弃, 已废弃, 已废弃
    ...
    // 属于高阶功能分类（功能大类 Advanced Functions）
    DEFE_AF_ECU_FLASH_POS                = 70,  // 0x40 0000 0000 0000 0000,  一级菜单掩码（功能大类）           ECU刷写              ECUFLASHING             1 << 70    ECU Flashing

    DEFE_MT_SOFT_EXPIRATION_POS          = 71,  // 0x80 0000 0000 0000 0000,  DEF_MT_SOFT_EXPIRATION             软件过期             SOFT_EXPIRE           1 << 71    Software Expiration
    
    
    // 以下连续7位属于高阶功能分类（功能大类 Advanced Functions）
    DEFE_AF_HOTFUN_POS                   = 72,  // 0x100 0000 0000 0000 0000,  一级菜单掩码（功能大类）          常用特殊功能         HOTFUNCTIONS           1 << 72    Hot Functions
    DEFE_AF_INIT_POS                     = 73,  // 0x200 0000 0000 0000 0000,  一级菜单掩码（功能大类）          初始化               INITIALIZE             1 << 73    Initialize
    DEFE_AF_CODING_POS                   = 74,  // 0x400 0000 0000 0000 0000,  一级菜单掩码（功能大类）          设码                 CODING                 1 << 74    Coding
    DEFE_AF_ADAPTATION_POS               = 75,  // 0x800 0000 0000 0000 0000,  一级菜单掩码（功能大类）          匹配                 ADAPTATION             1 << 75    Adaptation
    DEFE_AF_PROGRAMMING_POS              = 76,  // 0x1000 0000 0000 0000 0000, 一级菜单掩码（功能大类）          编程                 PROGRAMMING            1 << 76    Programming
    DEFE_AF_ECUCLONING_POS               = 77,  // 0x2000 0000 0000 0000 0000, 一级菜单掩码（功能大类）          ECU克隆              ECUCLONING             1 << 77    ECU Cloning
    DEFE_AF_CUSTOMIZE_POS                = 78,  // 0x4000 0000 0000 0000 0000, 一级菜单掩码（功能大类）          刷隐藏               CUSTOMIZE              1 << 78    Customize
}eDiagEntryTypeEx;

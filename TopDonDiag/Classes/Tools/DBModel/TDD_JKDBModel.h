...
#define primaryId   @"pk"
#define appTypeKey  @"appType"
typedef enum
{
    TDD_DATA_BASE_GROUP_DEFAULT     = 0, // 默认
    TDD_DATA_BASE_GROUP_VAG         = 1, // VAG
    TDD_DATA_BASE_GROUP_BMW         = 2, // BMW
    TDD_DATA_BASE_GROUP_FORD        = 3, // FORD
}TDD_DB_Group_App;

@interface TDD_JKDBModel : NSObject
